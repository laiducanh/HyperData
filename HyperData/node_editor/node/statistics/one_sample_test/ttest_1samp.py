...
class ResultDialog(ResultDialogBase):
    ...
    def initStats(self, result:TtestResult):
        TransparentPushButton(
            ...
            text2='How far the sample mean is from the population mean, in standard errors',
        ...
        TransparentPushButton(
            ...
            text2='The confidence interval around the population mean',
...
class Ttest1samp(TestBase):
    ...
    def set_config(self, config=None):
        ...
        self.popmean = DoubleSpinBox(
            min=-100000, max=100000, decimals=5, 
            text="Population mean",
            text2="Expected value in null hypothesis",
