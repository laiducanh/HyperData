...
from scipy.stats._continuous_distns import genhalflogistic

DEBUG = False

class Genhalflogistic (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = genhalflogistic(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Generalized half-logistic continuous distribution")
        dialog.exec()