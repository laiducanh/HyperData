...
from scipy.stats._continuous_distns import trapezoid

DEBUG = False

class Trapezoid (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = trapezoid(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Trapezoidal continuous distribution")
        dialog.exec()