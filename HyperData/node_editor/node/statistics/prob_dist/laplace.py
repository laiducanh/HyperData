...
from scipy.stats._continuous_distns import laplace

DEBUG = False

class Laplace (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = laplace(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Laplace continuous distribution")
        dialog.exec()