...
from scipy.stats._continuous_distns import truncexpon

DEBUG = False

class Truncexpon (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = truncexpon(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Truncated exponential continuous distribution")
        dialog.exec()