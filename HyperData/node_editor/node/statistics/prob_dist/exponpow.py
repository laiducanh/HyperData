...
from scipy.stats._continuous_distns import exponpow

DEBUG = False

class Exponpow (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = exponpow(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Exponential power continuous distribution")
        dialog.exec()