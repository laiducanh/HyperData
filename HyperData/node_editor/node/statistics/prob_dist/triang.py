...
from scipy.stats._continuous_distns import triang

DEBUG = False

class Triang (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = triang(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Triangular continuous distribution")
        dialog.exec()