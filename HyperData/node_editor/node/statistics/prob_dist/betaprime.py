...
from scipy.stats._continuous_distns import betaprime

DEBUG = False

class BetaPrime (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = betaprime(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Beta prime continuous distribution")
        dialog.exec()