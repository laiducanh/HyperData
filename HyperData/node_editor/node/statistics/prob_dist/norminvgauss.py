...
from scipy.stats._continuous_distns import norminvgauss

DEBUG = False

class NorminvGauss (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = norminvgauss(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Normal inverse Gaussian continuous distribution")
        dialog.exec()