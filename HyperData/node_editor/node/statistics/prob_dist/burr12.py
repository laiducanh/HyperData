...
from scipy.stats._continuous_distns import burr12

DEBUG = False

class Burr12 (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = burr12(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Burr (Type XII) continuous distribution")
        dialog.exec()