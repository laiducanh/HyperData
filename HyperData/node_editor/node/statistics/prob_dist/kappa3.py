...
from scipy.stats._continuous_distns import kappa3

DEBUG = False

class Kappa3 (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = kappa3(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Kappa 3 parameter distribution")
        dialog.exec()