...
from scipy.stats._continuous_distns import gumbel_r

DEBUG = False

class Gumbelr (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = gumbel_r(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Right-skewed Gumbel continuous distribution")
        dialog.exec()