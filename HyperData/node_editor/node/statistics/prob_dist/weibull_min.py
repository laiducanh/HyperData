...
from scipy.stats._continuous_distns import weibull_min

DEBUG = False

class Weibullmin (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = weibull_min(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Weibull minimum continuous distribution")
        dialog.exec()