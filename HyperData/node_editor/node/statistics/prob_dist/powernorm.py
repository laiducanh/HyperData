...
from scipy.stats._continuous_distns import powernorm

DEBUG = False

class Powernorm (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = powernorm(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Power normal continuous distribution")
        dialog.exec()