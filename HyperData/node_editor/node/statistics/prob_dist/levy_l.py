...
from scipy.stats._continuous_distns import levy_l

DEBUG = False

class Levyl (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = levy_l(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Left-skewed Levy continuous distribution")
        dialog.exec()