...
from scipy.stats._continuous_distns import wrapcauchy

DEBUG = False

class WrapCauchy (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = wrapcauchy(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Wrapped Cauchy continuous distribution")
        dialog.exec()