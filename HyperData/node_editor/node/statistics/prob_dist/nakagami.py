...
from scipy.stats._continuous_distns import nakagami

DEBUG = False

class Nakagami (DistBase):
    ...
    def set_config(self, config=None):
        ...
        self.nu = HTransparentDoubleSpinBox(label="nu")
    ...
    def update_config(self):
        self._config.update(
            ...
            nu = self.nu.button.value(),
        )
        self.dist = nakagami(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Nakagami continuous distribution")
        dialog.exec()