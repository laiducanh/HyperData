...
from scipy.stats._continuous_distns import ncx2
...
class NCX2 (DistBase):
    ...
    def set_config(self, config=None):
        ...
        self.nc = DoubleSpinBox(text='Lambda')
    ...
    def update_config(self):
        ...
        self.dist = ncx2(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Non-central chi-squared continuous distribution")
        dialog.exec()