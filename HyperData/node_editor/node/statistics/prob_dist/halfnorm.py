...
from scipy.stats._continuous_distns import halfnorm

DEBUG = False

class Halfnorm (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = halfnorm(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Half-normal continuous distribution")
        dialog.exec()