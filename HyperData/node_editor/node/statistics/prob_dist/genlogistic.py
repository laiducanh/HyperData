...
from scipy.stats._continuous_distns import genlogistic

DEBUG = False

class Genlogistic (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = genlogistic(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Generalized logistic continuous distribution")
        dialog.exec()