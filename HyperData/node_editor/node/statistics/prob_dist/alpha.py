...
class Alpha (DistBase):
    ...
    def set_config(self, config=None):
        ...
        self.a = HTransparentDoubleSpinBox(label="Alpha")
    ...
    def update_config(self):
        ...
        self.dist = alpha(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Alpha continuous distribution")
        dialog.exec()