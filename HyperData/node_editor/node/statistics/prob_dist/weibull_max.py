...
from scipy.stats._continuous_distns import weibull_max

DEBUG = False

class Weibullmax (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = weibull_max(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Weibull maximum continuous distribution")
        dialog.exec()