...
from scipy.stats._continuous_distns import ksone

DEBUG = False

class Ksone (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = ksone(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Kolmogorov-Smirnov one-sided distribution")
        dialog.exec()