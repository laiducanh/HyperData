...
from scipy.stats._continuous_distns import genexpon

DEBUG = False

class Genexpon (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = genexpon(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Generalized exponential continuous distribution")
        dialog.exec()