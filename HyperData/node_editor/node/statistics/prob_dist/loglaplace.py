...
from scipy.stats._continuous_distns import loglaplace

DEBUG = False

class LogLaplace (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = loglaplace(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Log-Laplace continuous distribution")
        dialog.exec()