...
from scipy.stats._continuous_distns import invgamma

DEBUG = False

class Invgamma (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = invgamma(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Inverted Gamma continuous distribution")
        dialog.exec()