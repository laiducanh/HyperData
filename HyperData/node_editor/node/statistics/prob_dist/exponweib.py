...
from scipy.stats._continuous_distns import exponweib

DEBUG = False

class ExponWeib (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = exponweib(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Exponentiated Weibull continuous distribution")
        dialog.exec()