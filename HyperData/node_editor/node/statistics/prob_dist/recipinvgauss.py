...
from scipy.stats._continuous_distns import recipinvgauss

DEBUG = False

class Recipinvgauss (DistBase):
    ...
    def set_config(self, config=None):
        ...
        self.mu = HTransparentDoubleSpinBox(label="mu")
    ...
    def update_config(self):
        ...
        self.dist = recipinvgauss(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Reciprocal Inverse Gaussian continuous distribution")
        dialog.exec()