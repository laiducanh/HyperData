...
from scipy.stats._continuous_distns import truncpareto

DEBUG = False

class Truncpareto (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = truncpareto(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Truncated Pareto continuous distribution")
        dialog.exec()