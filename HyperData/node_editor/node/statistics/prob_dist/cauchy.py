...
from scipy.stats._continuous_distns import cauchy

DEBUG = False

class Cauchy (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = cauchy(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Cauchy continuous distribution")
        dialog.exec()