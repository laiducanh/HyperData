...
from scipy.stats._continuous_distns import genextreme

DEBUG = False

class Genextreme (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = genextreme(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Generalized extreme value continuous distribution")
        dialog.exec()