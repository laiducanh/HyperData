...
from scipy.stats._continuous_distns import skewnorm

DEBUG = False

class Skewnorm (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = skewnorm(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Skew-normal continuous distribution")
        dialog.exec()