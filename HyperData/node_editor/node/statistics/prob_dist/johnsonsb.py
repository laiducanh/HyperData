...
from scipy.stats._continuous_distns import johnsonsb

DEBUG = False

class JohnsonSB (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = johnsonsb(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Johnson SB continuous distribution")
        dialog.exec()