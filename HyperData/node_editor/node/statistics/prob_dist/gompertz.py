...
from scipy.stats._continuous_distns import gompertz

DEBUG = False

class Gompertz (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = gompertz(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Gompertz continuous distribution")
        dialog.exec()