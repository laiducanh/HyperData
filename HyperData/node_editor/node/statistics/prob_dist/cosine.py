...
from scipy.stats._continuous_distns import cosine

DEBUG = False

class Cosine (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = cosine(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Cosine continuous distribution")
        dialog.exec()