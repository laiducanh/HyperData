...
from scipy.stats._continuous_distns import maxwell

DEBUG = False

class Maxwell (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = maxwell(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Maxwell continuous distribution")
        dialog.exec()