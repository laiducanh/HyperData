...
from scipy.stats._continuous_distns import jf_skew_t

DEBUG = False

class Jfskewt (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = jf_skew_t(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Jones and Faddy skew-t continuous distribution")
        dialog.exec()