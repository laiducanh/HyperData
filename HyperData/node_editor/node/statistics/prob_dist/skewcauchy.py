...
from scipy.stats._continuous_distns import skewcauchy

DEBUG = False

class SkewCauchy (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = skewcauchy(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Skewed Cauchy continuous distribution")
        dialog.exec()