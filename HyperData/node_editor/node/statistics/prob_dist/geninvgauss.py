...
from scipy.stats._continuous_distns import geninvgauss

DEBUG = False

class Geninvgauss (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = geninvgauss(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Generalized inverse Gaussian continuous distribution")
        dialog.exec()