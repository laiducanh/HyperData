...
from scipy.stats._continuous_distns import halfcauchy

DEBUG = False

class HalfCauchy (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = halfcauchy(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Half-Cauchy continuous distribution")
        dialog.exec()