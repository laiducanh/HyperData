...
from scipy.stats._continuous_distns import loguniform

DEBUG = False

class Loguniform (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = loguniform(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Loguniform continuous distribution")
        dialog.exec()