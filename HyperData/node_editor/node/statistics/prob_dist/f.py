...
class F (DistBase):
    ...
    def set_config(self, config=None):
        ...
        self.dfn = HTransparentComboBox(items=[str(i) for i in range(10)], label="Degrees of freedom in numerator")
        self.dfn.button.setCurrentText(str(self._config["dfn"]))
        self.vlayout.addWidget(self.dfn)

        self.dfd = HTransparentComboBox(items=[str(i) for i in range(10)], label="Degrees of freedom in denominator")
