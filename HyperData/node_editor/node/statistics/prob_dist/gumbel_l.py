...
from scipy.stats._continuous_distns import gumbel_l

DEBUG = False

class Gumbell (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = gumbel_l(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Left-skewed Gumbel continuous distribution")
        dialog.exec()