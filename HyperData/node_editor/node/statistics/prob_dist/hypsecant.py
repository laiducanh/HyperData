...
from scipy.stats._continuous_distns import hypsecant

DEBUG = False

class Hypsecent (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = hypsecant(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Hyperbolic secant continuous distribution")
        dialog.exec()