...
from scipy.stats._continuous_distns import gibrat

DEBUG = False

class Gibrat (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = gibrat(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Gibrat continuous distribution")
        dialog.exec()