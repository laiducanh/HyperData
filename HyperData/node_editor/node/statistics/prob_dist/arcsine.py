...
from scipy.stats._continuous_distns import arcsine

DEBUG = False

class Arcsine (DistBase):
    ...
    def update_config(self):
        ...
        self.dist = arcsine(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Arcsine continuous distribution")
        dialog.exec()