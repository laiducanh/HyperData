...
from scipy.stats._continuous_distns import genhyperbolic

DEBUG = False

class Genhyperbolic (DistBase):
    ...
    def set_config(self, config=None):
        ...
        self.p = HTransparentDoubleSpinBox(label="p")
    ...
    def update_config(self):
        ...
        self.dist = genhyperbolic(**self._config)
               
    def result_dialog(self):
        dialog = ResultDialog(self.dist, "Generalized hyperbolic continuous distribution")
        dialog.exec()