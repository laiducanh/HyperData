...
class ResultDialog(Dialog):
    def __init__(self, xdata, ydata, interpolator: BarycentricInterpolator,  parent=None):
    ...
    def plot(self, xdata, ydata, interpolator: BarycentricInterpolator):
        # clear plot
