...
class HDBSCAN(MethodBase):
    ...
    def set_config(self, config=None):
        ...
        self.min_cluster_size = HTransparentSpinBox(label="Minimum number of samples")
        ...
        self.cluster_selection_epsilon = HTransparentDoubleSpinBox(label="Distance threshold")
        ...
        self.alpha = HTransparentDoubleSpinBox(label="Scaling parameter")
        ...
        self.cluster_selection_method = HTransparentComboBox(items=["eom","leaf"], label="Method")
        ...
        self.allow_single_cluster = HToggle(label="Single cluster")
