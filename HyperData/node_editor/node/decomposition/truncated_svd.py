...
class TruncatedSVD(MethodBase):
    ...
    def set_config(self, config=None):
        ...
        self.algorithm = HTransparentComboBox(items=["arpack","randomized"], label="Algorithm")
        ...
        self.n_iter = HTransparentSpinBox(label="Number of iterations")
        ...
        self.n_oversamples = HTransparentSpinBox(label="Number of oversamples")
        ...
        self.power_iteration_normalizer = HTransparentComboBox(items=["auto","QR","LU","none"],label="Power iteration normalizer")
