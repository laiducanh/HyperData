...
class KernelPCA(MethodBase):
    ...
    def set_config(self, config=None):
        ...
        self.kernel = HTransparentComboBox(items=["linear","poly","rbf","sigmoid","cosine"], label="Kernel")
        ...
        self.eigen_solver = HTransparentComboBox(items=["auto","dense","arpack","randomized"], label="Solver")
