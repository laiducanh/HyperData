...
class HistGradientBoosting(RegressorBase):
    ...
    def set_config(self, config=None):
        ...
        self.estimator = ensemble.HistGradientBoostingRegressor(**self._config)

        self.loss = HTransparentComboBox(items=['squared_error','absolute_error','gamma','poisson','quantile'], label="Loss Function")
